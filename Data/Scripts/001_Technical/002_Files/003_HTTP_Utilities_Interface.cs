...
namespace PokemonEssentials
{
	...
	//	IDictionary<string, object> PostBody(string url, string body, string contentType, IDictionary<string, string> headers);
	//
	//	/// <summary>
	//	/// Sends an HTTP GET request with the specified headers.
	//	/// </summary>
	//	//object get(string url, IDictionary<string, string> headers);
	//	IDictionary<string, object> Get(string url, IDictionary<string, string> headers);
	//}
}