...
namespace PokemonEssentials
{
	...
	public interface IDir
	{
		...
		/// </summary>
		/// <param name="dir">The root directory to start the recursive search.</param>
		IList<string> AllDirs(string dir);
	...
	public interface IMainFileTests : IMain
	{
		...
		/// NOTE: <see cref="pbGetFileChar"/> checks anything added in MKXP's RTP setting, and matching
		...
		///       mount points added through System.mount.
		/// </remarks>
		IStringInput pbRgssOpen(string file, string mode = null, Action<System.IO.Stream> @yield = null);
