...
namespace PokemonEssentials
{
	...
	/// </summary>
	public interface IScenePokemonLoad : IScene, IUIScene, IHaveUpdate
	{
		/// <summary>
	...
	/// </summary>
	public interface IScreenPokemonLoad : IScreen
	{
		/// <summary>
		...
		IScreenPokemonLoad initialize(IScenePokemonLoad scene);
