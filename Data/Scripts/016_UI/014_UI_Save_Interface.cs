...
namespace PokemonEssentials
{
	...
	/// </summary>
	public interface IScenePokemonSave : IScene, IUIScene, IHaveUpdate
	{
		/// <summary>
	...
	/// </summary>
	public interface IScreenPokemonSave
	{
		/// <summary>
		...
		IScreenPokemonSave initialize(IScenePokemonSave scene);
