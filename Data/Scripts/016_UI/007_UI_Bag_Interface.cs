...
namespace PokemonEssentials
{
    ...
    public interface IScreenBag : IScreen, IUIScreen
    {
        ...
        /// <returns>The selected item, or null if cancelled.</returns>
        object StartScreen(IGameBag bag, Func<int, bool> filterProc = null);
        ...
        /// <returns>The selected item to give, or null if cancelled.</returns>
        object GiveItemScreen(IGameBag bag, IPokemon pokemon);
        ...
        bool UseItemScreen(IGameBag bag, IPokemon pokemon);
    }
    ...
    public interface IBagUtilities
    {
        ...
        bool UseItem(int item, IPokemon pokemon = null);
        ...
        bool GiveItem(IPokemon pokemon, int item);
        ...
        bool TossItem(int item, int quantity);
    ...
    public interface IBagPocketManager
    {
        ...
        IList<int> getPocketItems(int pocketIndex);
    ...
    public interface IBagItemFilter
    {
        ...
        IList<int> filterUsableItems(IList<int> items, string context);
        ...
        IList<int> filterGivableItems(IList<int> items, IPokemon pokemon = null);
        ...
        IList<int> filterItemsByType(IList<int> items, int itemType);
        ...
        IList<int> searchItemsByName(IList<int> items, string searchTerm);
    }
}